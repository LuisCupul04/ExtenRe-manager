...
class ExportSettingsActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (getFingerprint(callingPackage!!) == getFingerprint(packageName)) {
            ...
            // Load keystore
            val keystoreFile = File(getExternalFilesDir(null), "/extenre-manager.keystore")
            ...
            // Load saved patches
            val storedPatchesFile = File(filesDir.parentFile.absolutePath, "/app_flutter/selected-patches-exre.json")
