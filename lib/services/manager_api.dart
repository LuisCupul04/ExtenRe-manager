...
import 'package:extenre_manager/ui/widgets/shared/haptics/haptic_checkbox_list_tile.dart';
...
class ManagerAPI {
  ...
  final String patcherRepo = 'extenre-patcher';
  final String cliRepo = 'extenre-cli';
  ...
  int sdkVersion = 0;
  String storedPatchesFile = '/selected-patches-exre.json';
  String keystoreFile =
      '/sdcard/Android/data/com.exre.manager.flutter/files/extenre-manager.keystore';
  String defaultKeystorePassword = 's3cur3p@ssw0rd';
  String defaultApiUrl = 'https://api.extenre.app/v4';
  String defaultRepoUrl = 'https://api.github.com';
  String defaultPatchesRepo = 'luiscupul04/extenre-patches';
  String defaultManagerRepo = 'luiscupul04/extenre-manager';
  ...
  Future<void> initialize() async {
    ...
    if (!hasMigratedToNewMigrationSystem) {
      ...
      final isReleases = apiUrl.contains('releases.extenre.app');
      final isDomain = apiUrl.endsWith('api.extenre.app');
      final isV2 = apiUrl.contains('api.extenre.app/v2');
      final isV3 = apiUrl.contains('api.extenre.app/v3');
  ...
  Future<void> resetApiUrl() async {
    ...
    await _extenreAPI.clearAllCache();
  ...
  Future<void> deleteTempFolder() async {
    final Directory dir = Directory('/data/local/tmp/extenre-manager');
    if (await dir.exists()) {
  ...
  Future<Map<String, List<dynamic>>> getContributors() async {
    return contributors ??= await _extenreAPI.getContributors();
  }
