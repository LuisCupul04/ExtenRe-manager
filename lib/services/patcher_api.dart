...
@lazySingleton
class PatcherAPI {
  static const patcherChannel = MethodChannel('com.extenre.manager.flutter/patcher');
  ...
  Future<void> initialize() async {
    ...
    _keyStoreFile = File('${_dataDir.path}/extenre-manager.keystore');
    cleanPatcher();
  }
  ...
  Future<void> runPatcher(
    ...
    final Directory tmpDir =
        Directory('${workDir.path}/extenre-temporary-files');
  ...
  String _getFileName(String appName, String version) {
    ...
    final String newName =
        '$prefix-extenre_v$version-patches_$patchVersion.apk';
    return newName;
  }
  ...
  Future<void> exportPatcherLog(String logs) async {
    ...
    final String dateTime = DateTime.now()
        ...
        .replaceAll('T', '')
        .replaceAll('.', '');
    final String fileName = 'extenre-manager_patcher_$dateTime.txt';
