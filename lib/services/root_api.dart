...
class RootAPI {
  final String _extenreDirPath = '/data/adb/extenre';
  ...
  Future<List<String>> getInstalledApps() async {
    ...
    try {
      final String? res = await Root.exec(cmd: 'ls $_extenreDirPath');
      if (res != null) {
  ...
  Future<void> uninstall(String packageName) async {
    await Root.exec(
      cmd: '''
          ...
          rm -rf $_extenreDirPath/$packageName $_serviceDDirPath/$packageName.sh
          ''',
    );
  }
  ...
  Future<void> removeOrphanedFiles() async {
    await Root.exec(
      cmd: 'find $_extenreDirPath -type f -name original.apk -delete',
    );
  }
  ...
  Future<void> installServiceDScript(String packageName) async {
    ...
    base_path=$_extenreDirPath/$packageName/base.apk
  ...
  Future<void> installPatchedApk(
    ...
    final String newPatchedFilePath = '$_extenreDirPath/$packageName/base.apk';
    await Root.exec(
      cmd: '''
      mkdir -p $_extenreDirPath/$packageName
