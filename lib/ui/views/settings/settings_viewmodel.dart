...
import 'package:extenre_manager/app/app.router.dart';
...
import 'package:extenre_manager/ui/views/patches_selector/patches_selector_viewmodel.dart';
...
class SettingsViewModel extends BaseViewModel {
  ...
  Future<void> exportLogcatLogs() async {
    ...
    final File logcat = File(
      '${logDir.path}/extenre-manager_logcat_$dateTime.log',
    );
